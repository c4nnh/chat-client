  ...
  <Icon
    component={() => (
      <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
        <path
          fill={props.fill}
          d="M7 13.025V11q0-1.4-.713-2.45-.712-1.05-2.162-1.3V6.2q0-1.2.85-2.025T7 3.35h10.025q1.2 0 2.037.825Q19.9 5 19.9 6.2v1.05q-1.425.5-2.15 1.425-.725.925-.725 2.325v2.025ZM5.125 20.7q-.4 0-.675-.262-.275-.263-.275-.663v-1h-.05q-1.175 0-2.012-.837-.838-.838-.838-2.013V11q0-.875.525-1.4.525-.525 1.4-.525.875 0 1.4.525.525.525.525 1.4v3.9H18.9V11q0-.875.525-1.4.525-.525 1.4-.525.875 0 1.4.525.525.525.525 1.4v4.925q0 1.175-.825 2.013-.825.837-2.025.837h-.05v1q0 .4-.275.663-.275.262-.675.262t-.662-.262q-.263-.263-.263-.663v-1H6.05v1q0 .375-.262.65-.263.275-.663.275Z"
        />
      </svg>
    )}
    {...props}
